//Se incluyen las librerias necesarias y aparte se incluye la libreria <define.h> en donde estan las funciones declaradas
#include<define.h>
#include<stdio.h>
#include<stdlib.h>

//En esta parte estan las funciones que se usaran en la funcion main
